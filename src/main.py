...
if __name__ == '__main__':
    ...
    config_dict["experiment"] = alg_config["name"] if "experiment" not in alg_config else alg_config["experiment"]
    ...
    file_obs_path = os.path.join(results_path, config_dict["map_name"], "{}".format(config_dict["experiment"]), "sacred", config_dict["mixer"])
